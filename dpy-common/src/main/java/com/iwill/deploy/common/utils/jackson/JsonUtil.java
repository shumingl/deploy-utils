package com.iwill.deploy.common.utils.jackson;
...
public class JsonUtil {
    ...
    public static <T> T json2Object(Class<T> targetClzz, String jsonString) {
        return json2Object(targetClzz, null, jsonString);
    }
    ...
    public static <T> List<T> json2List(Class<T> targetClzz, String jsonString) {
        JsonConverter jsonConverter = JsonConverter.getInstance();
        return jsonConverter.json2List(targetClzz, jsonString);
    }
